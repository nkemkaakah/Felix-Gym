    ...
    return (
        <header className={`border-b-2  w-full z-30 left-0 right-0 mx-auto top-0 flex justify-between items-center px-[10px] lg:px-[40px] transition-all duration-300`}>
            ...
            <div className='hidden lg:flex space-x-0 '>
                ...
                <button className={`btn btn-sm  btn-primary btn-secondary bg-black text-white rounded-md hover:bg-black/70 transition-all duration-300 `} onClick={handleOpen}>SignUp</button>
            </div>
