...
export function TrainingMobileDropDown({ dark }) {
  return (
    ...
    >
      <MenuHandler>
        <Button className={`text-lg md:text-xl lg:text-[25px] xl:text-4xl xxl:text-[60px] hover:text-green-600 font-semibold  transition duration-300  border-none p-0 bg-transparent shadow-none`} > Training Programs</Button>
      </MenuHandler>
      <MenuList className="flex flex-col gap-3">
        <Link to="/training-programs/a9dB12fXcH7J3gT6L9Q4">Gutzfit Muscle Blast</Link>
        <Link to="/training-programs/z4Xy8VwN2Pq7H1R5m6K9">Gutzfit Tone Up</Link>
...
export function FollowMeDropDown({ dark }) {
  return (
    ...
    >
      <MenuHandler>
        <Button className={`text-lg ${!dark ? "text-black" : ""} md:text-xl lg:text-[25px] xl:text-4xl xxl:text-[60px] hover:text-green-600 font-semibold  transition duration-300  border-none p-0 bg-transparent shadow-none`} > Follow Me</Button>
      </MenuHandler>
      <MenuList className="flex flex-col gap-3">
